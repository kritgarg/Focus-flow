    ...
    <div className="w-[360px] max-w-full bg-white rounded-3xl p-6 shadow-xl relative">
      ...
      <div className="relative z-10 h-[500px] flex flex-col">
        <div className="flex items-center gap-3 mb-3">
          <FaRegStickyNote className="text-xl text-purple-600" />
          <h2 className="text-lg font-bold text-gray-800 tracking-wide font-sans">Sticky Notes</h2>
        </div>
        ...
        <div className="flex mb-4">
          <input
            ...
            maxLength={100}
            className="flex-1 bg-transparent border-2 border-purple-400 rounded-l-full px-4 py-2 outline-none text-sm text-gray-800 placeholder-gray-400 font-medium"
          />
          <button
            onClick={addNote}
            className="bg-purple-500 hover:bg-purple-600 text-white px-4 rounded-r-full flex items-center justify-center"
          >
            <FaPlus />
          </button>
        </div>

        <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-purple-300 pr-1 flex flex-wrap gap-3">
          {notes.map((note) => (
            <div
              key={note.id}
              className="relative px-4 py-3 rounded-xl text-sm font-medium text-gray-800 shadow-md w-[140px] min-h-[100px] break-words"
